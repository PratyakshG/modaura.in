...
export default function ShipmentDetailsPage() {
  ...
  return (
    <div>
      <Link href="/admin/shipments" className="flex items-center gap-2 text-blue-600 hover:text-blue-700 mb-6">
        <ArrowLeft size={18} />
        Back to Shipments
      </Link>

      <h1 className="text-3xl font-bold mb-2">Shipment #{shipment.trackingNumber}</h1>
      <p className="text-slate-600 mb-8">Created {new Date(shipment.createdAt).toLocaleString()}</p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <p>{shipment.estimatedDeliveryDate ? new Date(shipment.estimatedDeliveryDate).toLocaleDateString() : "N/A"}</p>
              </div>
            </div>
          </div>
